...
{
    public class BodyMetricsModel : PageModel
    {
        private readonly ApplicationDbContext _db;

        public BodyMetricsModel(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        public string ChartData => JsonSerializer.Serialize(
            Measurements.OrderBy(m => m.Date).Select(m => new
            {
